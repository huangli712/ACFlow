...
Mutable struct. An internal mesh used in stochastic methods. It supports
both uniform and non-uniform meshes. The mesh is usually generated by
`util/gmesh.jl` and loaded dynamically in the initialization step. This
mesh should not be used as a regular mesh for the spectrum.
